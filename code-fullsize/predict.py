...
root1='/Volumes/Seagate Backup Plus Drive/output01'
root2='/Volumes/Seagate Backup Plus Drive/yellowcolor01'
ROOT_PRED='/Volumes/Seagate Backup Plus Drive/val01'
img_h,img_w= 992,1344
model=unet()
model.load_weights('/Users/ark/Downloads/code-3/check_points/weights-improvement-01.hdf5')
